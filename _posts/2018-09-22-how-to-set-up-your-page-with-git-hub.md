...
1. Create a new repo in the GitHub application. Name format: **username.github.io**. Push your repo.
2. Move website files to the repo. Home page HTML file name : index.html Commit and push them 
3. I used https://html5up.net/
4. 
